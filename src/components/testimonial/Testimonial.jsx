...
function Testimonial() {
    ...
    return (
        <div>
            <section className="text-gray-600 body-font mb-5" style={{backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : ''}}>
                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                <img alt="testimonial" className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="https://cdn-icons-png.flaticon.com/128/3917/3917711.png" />
