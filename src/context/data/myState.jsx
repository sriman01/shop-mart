...
function MyState(props){
    ...
    return (
        ...
        products, setProducts, addProduct, product, edithandle, updateProduct, deleteProduct, order, user, searchKey, setSearchKey, filterPrice, setFilterPrice, setFilterType,filterType}}>
            {props.children}
        </MyContext.Provider>
    )
}
