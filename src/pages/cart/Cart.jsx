...
function Cart() {
  ...
  useEffect(() => {         //delete data stored in local storage
  ...
  const shipping = parseInt(cartItems.length === 0 ? 0 : 90);
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_Z9oOdY4t0cUAo1",
      key_secret: "iyulz7NQdiluoEFM8lUhdk4K",
